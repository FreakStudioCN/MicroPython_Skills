...
- Never expose renderer path/root/budget arguments to a model or browser client. The host wrapper supplies them, and the fixed script independently enforces the allowed root and resource limits.
